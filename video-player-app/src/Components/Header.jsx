...
import nLogo from "../assests/logo.png";
import nprofile from "../assests/jack.png";
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
      ...
      <div className="flex h-5 items-center">
        {pageName !== "video" && (
          <div
            className="flex md:hidden md:mr-6 cursor-pointer items-center justify-center h-10 w-10 rounded-full hover:bg-[#30303]/[0.6]"
        ...
        <img className="h-full hidden dark:md:block w-8" src={nLogo} alt='' />
        <img className="h-full md:hidden"   src={nLogo} alt='' />
        </Link>
      </div>
